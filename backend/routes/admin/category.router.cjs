...
// ✅ Create a New Category (React API)
...
// ✅ Get Single Category by ID (React API)
...
// ✅ Update a Category by ID (React API)
...
// ✅ Delete a Category by ID (React API)
